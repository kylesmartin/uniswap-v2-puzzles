...
contract Twap {
    ...
    function second1HourSnapShot() public returns (uint224 oneHourTwap) {
        ...
        oneHourTwap = uint224(
            (second1HourSnapShot_Price0Cumulative - first1HourSnapShot_Price0Cumulative) / timeElapsed
        );
    ...
    function second1DaySnapShot() public returns (uint224 oneDayTwap) {
        ...
        oneDayTwap = uint224(
            (second1DaySnapShot_Price0Cumulative - first1DaySnapShot_Price0Cumulative) / timeElapsed
        );
